...
const deployedContracts = {
  ...
  11155111: {
    DEX: {
      address: "0x73B129413d41700140881B00931B71549D141C83",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9823429,
    },
    MyUSD: {
      address: "0x1b17A59971Dd30760715E6739FAAa2289c70F064",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9823428,
    },
    MyUSDEngine: {
      address: "0x732dD61fCB2159F5587EBfb4BCD75b76EF9d0E30",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9823432,
    },
    MyUSDStaking: {
      address: "0x0eC6b9A8bc4bc5FdEAbEB05a8AEE074De80336D7",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9823431,
    },
    Oracle: {
      address: "0xBD1195A26F5b6388d3D73b82c4e3b2741a85FdbC",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9823430,
    },
    RateController: {
      address: "0x7d985020Aaf4e4D3C2607C9DEC4f97AAF0641f16",
      abi: [
        {
          inputs: [
            {
